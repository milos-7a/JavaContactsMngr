package com.milos.contactsmanager.main;
...
public class Main {
    ...
    private static final KontaktService kontaktService = new KontaktService();
    private static final DetaljiService detaljiService = new DetaljiService();
    ...
    public static void main(String[] args) {
        ...
        while (radi) {
            ...
            switch (scanner.nextLine()) {
                case "1" -> prikaziSve();
                case "2" -> dodajKontakt();
                case "3" -> pretraziKontakt();
                case "4" -> azurirajKontakt();
                case "5" -> obrisiKontakt();
                case "6" -> upravljajDetaljima();
                case "7" -> radi = false;
                default -> System.err.println("Nepoznata opcija!");
            }
        }
    ...
    private static void azurirajKontakt() {
    ...
    private static void obrisiKontakt() {
    ...
    private static void upravljajDetaljima() {
        prikaziSve();
        ...
        while (radi) {
            ...
            switch (scanner.nextLine()) {
                case "1" -> prikaziDetalje(kontaktId);
                case "2" -> dodajDetalj(kontaktId);
                case "3" -> obrisiDetalj(kontaktId);
                case "4" -> radi = false;
                default -> System.err.println("Nepoznata opcija!");
            }
        }
    ...
    private static void prikaziDetalje(int kontaktId) {
    ...
    private static void dodajDetalj(int kontaktId) {
        System.out.println("""
                1.Telefon
                2.Email
                3.Link""");
        ...
        try{
            switch (tip) {
                ...
                default -> System.out.println("Nepoznat tip detalja.");
            }
        } catch (DetaljiServisException e) {
    ...
    private static void obrisiDetalj(int kontaktId) {
